...
.dA-hero-cta{margin-top:28px;display:flex;flex-direction:column;gap:22px;align-items:flex-start}
      ...
      {tw.showProof && (
        <section className="dA-proof" id="proof">
          <div className="wrap">
            ...
            />
            <div className="dA-sec-cta" style={{ marginTop: 12 }}><CTA href={emp} variant="ghost" size="md">{T.adv_cta}</CTA></div>
          </div>
        </section>
      )}
      ...
      {tw.showProcess && (
        <section className="dA-sec" id="process">
          <div className="wrap dA-sec-in">
            ...
            <div className="dA-sec-cta"><CTA href={emp} variant="navy" size="md">{T.process_cta}</CTA></div>
          </div>
        </section>
      )}
      ...
      {tw.showAdv && (
        <section className="dA-sec dA-sec-soft" id="adv">
          <div className="wrap dA-sec-in">
            ...
            <div className="dA-sec-cta"><CTA href={emp} variant="navy" size="md">{T.adv_cta}</CTA></div>
          </div>
        </section>
      )}
      ...
      {tw.showVid && (
        <section className="dA-sec">
          <div className="wrap dA-vid-in">
            ...
            <MediaFrame url={tw.vidVideoUrl} label={T.vid_media} ratio="16 / 10" className="dA-vid-media" />
          </div>
        </section>
      )}
